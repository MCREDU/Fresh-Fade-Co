<?php
    ...
    if(isset($_SESSION['username_barbershop_Xw211qAAsq4']) && isset($_SESSION['password_barbershop_Xw211qAAsq4']))
    {
        ...
        if($_SERVER['REQUEST_METHOD'] == 'POST') {
            ...
            $author_id = $_SESSION['admin_id'] ?? 1; // Default to admin ID 1 if not set
            ...
            if(empty($errors)) {
                $stmt = $con->prepare("INSERT INTO blog_posts (title, content, excerpt, tags, status, image_url, author_id) VALUES (?, ?, ?, ?, ?, ?, ?)");
                $stmt->execute(array($title, $content, $excerpt, $tags, $status, $image_url, $author_id));
                ...
                if($stmt->rowCount() > 0) {
                    ...
                    $errorMsg = "Error adding blog post!";
                }
            } else {
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="excerpt" name="excerpt" rows="4"><?php echo isset($excerpt) ? htmlspecialchars($excerpt) : ''; ?></textarea>
                                ...
                                <?php if(isset($successMsg) && isset($_POST['status']) && $_POST['status'] == 'published'): ?>
                                    <div class="form-group">
                                        <a href="../blog-post.php?id=<?php echo $con->lastInsertId(); ?>" 
